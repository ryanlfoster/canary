...
@Slf4j
@MonitoredServiceDefinition(name = 'Slow Sometimes Successful', description = 'Should always return success', pollFrequency = 1, pollFrequencyUnit = TimeUnit.MINUTES)
class SlowSometimesSuccessfulMonitor implements MonitoredService {

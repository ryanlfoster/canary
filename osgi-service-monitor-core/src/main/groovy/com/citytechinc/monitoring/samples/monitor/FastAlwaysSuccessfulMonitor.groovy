...
@Slf4j
@MonitoredServiceDefinition(name = 'Fast Always Successful', description = 'Should always return success', pollFrequency = 1, pollFrequencyUnit = TimeUnit.SECONDS)
class FastAlwaysSuccessfulMonitor implements MonitoredService {

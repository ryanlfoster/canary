...
@Slf4j
@MonitoredServiceDefinition(name = 'Slow Never Successful', description = 'Should always return failure', pollFrequency = 1, pollFrequencyUnit = TimeUnit.MINUTES)
class SlowNeverSuccessfulMonitor implements MonitoredService {

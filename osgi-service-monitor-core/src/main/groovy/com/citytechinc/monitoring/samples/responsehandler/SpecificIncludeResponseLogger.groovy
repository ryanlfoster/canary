...
import com.citytechinc.monitoring.samples.monitor.SometimesSuccessfulMonitor
...
@Slf4j
@PollResponseHandlerDefinition(subscriptionStrategy = SubscriptionStrategy.opt_into, subscriptionStrategySpecifics = [SometimesSuccessfulMonitor])

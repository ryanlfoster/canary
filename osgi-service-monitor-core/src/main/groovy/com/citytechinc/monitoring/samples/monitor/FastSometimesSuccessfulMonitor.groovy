...
@Slf4j
@MonitoredServiceDefinition(name = 'Fast Sometimes Successful', description = 'Should always return success', pollFrequency = 1, pollFrequencyUnit = TimeUnit.SECONDS)
class FastSometimesSuccessfulMonitor implements MonitoredService {

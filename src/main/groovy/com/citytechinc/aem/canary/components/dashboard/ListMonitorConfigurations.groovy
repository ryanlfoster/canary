...
@SlingServlet(
        ...
        extensions = 'json')
class ListMonitorConfigurations extends AbstractJSONResponseServlet {
    ...
    protected void doGet(final SlingHttpServletRequest request, final SlingHttpServletResponse response) {
        ...
        writeJsonResponse(response, new JsonBuilder(serviceManager.monitoredServicesConfigurations))
    }
}

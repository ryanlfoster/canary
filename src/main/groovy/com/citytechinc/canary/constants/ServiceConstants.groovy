...
class ServiceConstants {
    ...
    static final String JCR_NODE_TYPE_MONITORED_SERVICE_STORAGE = 'ctservmon:MonitorServiceStorage'
    static final String JCR_NODE_TYPE_DETAILED_POLL_RESPONSE = 'ctservmon:DetailedPollResponse'
    static final String JCR_NODE_TYPE_RECORD_HOLDER = 'ctservmon:RecordHolder'
